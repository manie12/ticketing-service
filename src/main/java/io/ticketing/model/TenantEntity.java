...
public class TenantEntity implements org.springframework.data.domain.Persistable<UUID> {
    ...
    public TenantEntity setStatus(String status) {
        this.status = status;
        return this;
    }
    ...
    public TenantEntity setDefaultTimezone(String defaultTimezone) {
        this.defaultTimezone = defaultTimezone;
        return this;
    }
    ...
    public TenantEntity setDefaultLocale(String defaultLocale) {
        this.defaultLocale = defaultLocale;
        return this;
    }
    ...
    public TenantEntity setUpdatedAt(OffsetDateTime updatedAt) {
        this.updatedAt = updatedAt;
        return this;
    }
}